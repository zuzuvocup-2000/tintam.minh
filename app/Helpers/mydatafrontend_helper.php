...
if (! function_exists('get_slide')) {
    function get_slide($param = [])
    {
        ...
        $catalogue = $model->_get_where([
            'select' => 'tb3.id, tb1.keyword, tb2.title as cat_title, tb3.title, tb3.canonical, tb3.alt, tb3.description,tb2.description as cat_description, tb3.content, tb3.image',
            'table'    => 'slide_catalogue as tb1',
            'join' => [
                [
                    'slide_catalogue_translate as tb2',
                    'tb1.id = tb2.objectid  AND tb2.language = \'' . $param['language'] . '\' ',
                    'inner'
                ],
                [
                    'slide_translate as tb3',
                    'tb1.id = tb3.catalogueid  AND tb3.language = \'' . $param['language'] . '\'',
                    'inner'
                ]
            ],
            'where'    => $where,
...
if (! function_exists('location')) {
    function location($lang = '', $keyword = '')
    {
        ...
        $flag = $model->_get_where([
            ...
            'join' => [
                [
                    'location_translate as tb2',
                    'tb1.id = tb2.objectid AND tb2.module = "location_catalogue" AND tb2.language = \'' . $lang . '\' AND tb2.attribute = \'' . $keyword . '\'',
                    'inner'
                ]
            ],
            'where' => [
        ...
        $flag = $model->_get_where([
            ...
            'join' => [
                [
                    ...
                    'tb1.id = tb2.objectid AND tb2.module = \'' . $param['module'] . '\' AND tb2.language = \'' . $param['language'] . '\'',
                    'inner'
                ]
            ],
            'where' => [
        ...
        $flag = $model->_get_where([
            ...
            'join' => [
                [
                    ...
                    'tb1.id = tb2.objectid AND tb2.module = "brand" AND tb2.language = \'' . $lang . '\' ',
                    'inner'
                ]
            ],
    ...
    function attribute($lang = '')
    {
        ...
        $module = $model->_get_where([
            ...
            'join' => [
                [
                    ...
                    'tb1.id = tb2.objectid AND tb2.module = "attribute_catalogue"  AND tb2.language = \'' . $lang . '\'',
                    'inner'
                ],
            ],
            'order_by' => 'tb2.id asc'
        ...
        $data = $model->_get_where([
            ...
            'join' => [
                [
                    'attribute_translate as tb2',
                    'tb1.id = tb2.objectid AND tb2.module = "attribute" AND tb2.language = \'' . $lang . '\'',
                    'inner'
                ],
            ],
