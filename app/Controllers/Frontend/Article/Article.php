    ...
    public function index($id = 0, $page = 1)
    {
        ...
        $this->data['object'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                [
                    ...
                    'tb1.id = tb2.objectid AND tb2.module = \'' . $module_extract[0] . '\' ',
                    'inner'
                ],
                [
                ...
                [
                    $module_extract[0] . '_translate as tb4',
                    'tb4.module = \'' . $module_extract[0] . '_catalogue\' AND tb4.objectid = tb1.catalogueid AND tb3.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ],
                [
                    'user as tb5',
        ...
        $this->data['detailCatalogue'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                ...
                [
                    $module_extract[0] . '_translate as tb3',
                    'tb3.module = \'' . $this->data['module'] . '_catalogue\' AND tb3.objectid = tb1.id AND tb3.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ]
            ],
            'where' => [
        ...
        if ($catalogueid > 0) {
            $catalogue = $this->AutoloadModel->_get_where([
                ...
                'join' =>  [
                    [
                        'article_translate as tb3',
                        'tb1.id = tb3.objectid AND tb3.language = \'' . $this->currentLanguage() . '\' AND tb3.module = "article_catalogue"',
                        'inner'
                    ],
                ],
