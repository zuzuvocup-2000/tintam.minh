        ...
        $config['total_rows'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                [
                    ...
                    'tb1.id = tb2.objectid AND tb2.module = "article" ',
                    'inner'
                ],
                [
                    'article_translate as tb3',
                    'tb1.id = tb3.objectid AND tb3.module = "article" AND tb3.language = \'' . $this->currentLanguage() . '\' ',
                    'inner'
                ],
                [
                    'article_translate as tb4',
                    'tb4.module = "article_catalogue" AND tb4.objectid = tb1.catalogueid AND tb3.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ],
                [
                    'user as tb5',
                    'tb1.userid_created = tb5.id',
                    'left'
                ]
            ],
            'count' => TRUE
    ...
    private function search_media($page = 1, $module = 'media')
    {
        ...
        $config['total_rows'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                [
                    'object_relationship as tb2',
                    'tb1.id = tb2.objectid AND tb2.module = "media" ',
                    'inner'
                ],
                [
                    'media_translate as tb3',
                    'tb1.id = tb3.objectid AND tb3.module = "media" AND tb3.language = \'' . $this->currentLanguage() . '\' ',
                    'inner'
                ],
                [
                    'media_translate as tb4',
                    'tb4.module = "media_catalogue" AND tb4.objectid = tb1.catalogueid AND tb3.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ],
                [
                    'user as tb5',
    ...
    private function search_product($page = 1, $module = 'product')
    {
        ...
        $config['total_rows'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                ...
                [
                    ...
                    'tb1.id = tb3.objectid AND tb3.module = "product" AND tb3.language = \'' . $this->currentLanguage() . '\' ',
                    'inner'
                ],
                [
                    'product_translate as tb4',
                    'tb4.module = "product_catalogue" AND tb4.objectid = tb1.catalogueid AND tb4.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ],
                [
                    'user as tb5',
        ...
        if ($config['total_rows'] > 0) {
            ...
            $productList = $this->AutoloadModel->_get_where([
                'select' => 'tb1.publish,tb1.id,tb1.viewed, tb1.image,tb1.price,tb1.price_promotion, tb1.productid, tb1.model, tb1.bar_code, tb1.hot, tb4.title as cat_title,tb1.catalogue, tb4.canonical as cat_canonical, tb3.title, tb3.canonical, tb3.meta_title, tb1.album, tb3.meta_description,tb3.icon, tb1.viewed, tb3.description, tb3.content, tb1.created_at, tb5.fullname, tb1.length, tb3.huong',
                'table' => 'product as tb1',
                'where' => [
                    'tb1.deleted_at' => 0,
                ],
        ...
        if ($catalogueid > 0) {
            $catalogue = $this->AutoloadModel->_get_where([
                ...
                'join' =>  [
                    [
                        'product_translate as tb3',
                        'tb1.id = tb3.objectid AND tb3.language = \'' . $this->currentLanguage() . '\' AND tb3.module = "product_catalogue"',
                        'inner'
                    ],
                ],
