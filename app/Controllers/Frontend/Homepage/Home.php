...
class Home extends FrontendController{
	...
	public function index(){
		...
		if(isset($productCatalogueList) && is_array($productCatalogueList) && count($productCatalogueList)){
			$listid = $this->condition_catalogue($productCatalogueList['id']);
			$productCatalogueList['data'] = $this->AutoloadModel->_get_where([
	...
	public function aboutus(){
        ...
        $session = session();
		$this->data['general'] = $this->general;
		$this->data['meta_title'] = ($this->data['language'] == 'vi' ? 'Giới thiệu' : 'Introduce');
		$this->data['meta_description'] = (isset($this->data['general']['seo_meta_description']) ? $this->data['general']['seo_meta_description'] : '');
		$this->data['og_type'] = 'website';
		$this->data['canonical'] = base_url('gioi-thieu');
		$this->data['template'] = 'frontend/homepage/home/aboutus';
		return view('frontend/homepage/layout/home', $this->data);
	}
