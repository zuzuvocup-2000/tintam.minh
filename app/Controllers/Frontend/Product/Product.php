...
class Product extends FrontendController
{
    ...
    public function index($id = 0, $page = 1)
    {
        ...
        $this->data['object'] = $this->AutoloadModel->_get_where([
            'select' => 'tb1.publish,tb1.id,tb1.price,tb1.sub_album, tb1.price_promotion,tb1.catalogueid, tb1.viewed, tb1.album, tb1.image, tb2.title, tb2.canonical,tb2.sub_album_title,tb2.made_in, tb2.meta_title, tb2.sub_title,tb2.video, tb2.shock, tb2.sub_content, tb1.productid, tb2.meta_description,  tb2.description, tb2.content, tb1.bar_code, tb1.model, tb1.brandid, tb1.articleid, tb1.icon, tb1.rate, tb3.title as brand_title , tb2.type, tb2.info, tb1.created_at, tb2.brand, tb4.title as cat_title',
            ...
            'join' => [
                [
                    ...
                    'tb1.id = tb2.objectid AND tb2.module = "product" AND tb2.language = \'' . $this->currentLanguage() . '\' ',
                    'inner'
                ],
                [
                    'brand_translate as tb3',
                    'tb1.brandid = tb3.objectid AND tb3.module = "brand" AND tb3.language = \'' . $this->currentLanguage() . '\' ',
                    'left'
                ],
                [
                    'product_translate as tb4',
                    'tb1.catalogueid = tb4.objectid AND tb4.module = "product_catalogue" AND tb4.language = \'' . $this->currentLanguage() . '\' ',
                    'inner'
                ]
            ],
        ]);
        ...
        $this->data['detailCatalogue'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                [
                    $module_extract[0] . '_translate as tb2',
                    'tb2.module = \'' . $this->data['module'] . '_catalogue\' AND tb2.objectid = tb1.id AND tb2.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ]
            ],
            'where' => [
        ...
        $this->data['child'] = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                [
                    $module_extract[0] . '_translate as tb2',
                    'tb2.module = \'' . $module_extract[0] . '_catalogue\' AND tb2.objectid = tb1.id AND tb2.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ]
            ],
            'where' => [
    ...
    private function product_general($module_extract = [], $id = [])
    {
        $product_general = $this->AutoloadModel->_get_where([
            ...
            'join' => [
                [
                    $module_extract[0] . '_translate as tb2',
                    'tb2.module = \'' . $module_extract[0] . '\' AND tb2.objectid = tb1.objectid AND tb2.language = \'' . $this->currentLanguage() . '\'',
                    'inner'
                ],
                [
                    $module_extract[0] . ' as tb3',
                    'tb1.objectid = tb3.id AND tb3.deleted_at = 0',
                    'inner'
                ]
            ],
            'where' => [
            ...
            $catalogue = $this->AutoloadModel->_get_where([
                ...
                'join' =>  [
                    [
                        ...
                        'tb1.id = tb3.objectid AND tb3.language = \'' . $this->currentLanguage() . '\' AND tb3.module = "product"',
                        'inner'
                    ],
                ],
