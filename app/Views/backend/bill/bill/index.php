                        ...
                        <tbody>
                            ...
                            <tr id="post-<?php echo $value['id']; ?>" data-id="<?php echo $value['id']; ?>">
                                ...
                                <td style="color:blue">
                                    ...
                                    <div class="mb5"><span>Công ty: <?php echo $value['company'] ?></span></div>
                                </td>
                                <td style="color:blue">
                                    <div class="mb5"> <span>Quốc gia: <?php echo $value['nation'] ?></span></div>
                                    <div class="mb5"> <span>Thành phố: <?php echo $value['city'] ?></span></div>
                                ...
                                <td style="color:blue">
                                    ...
                                    <div class="mb5"><span class="text">Mã bưu điện </span>: <span class="text-danger"><?php echo $value['qrpost'] ?></span></div>
                                </td>
