        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="" method="">
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20 uk-flex-wrap">
                            <div class="perpage">
                            ...
                            <table class="table table-striped table-bordered nd_accordion table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr id="post-<?php echo $val['id']; ?>" class="" data-id="<?php echo $val['id']; ?>" data-module="<?php echo $module ?>">
                                        ...
                                        <td class="text-center " style="display: none;"><a class="text-small <?php echo ($val[$valLanguage['canonical'].'_detect'] > 0 ) ? 'text-success' : 'text-danger' ?> " href="<?php echo base_url('backend/translate/translate/translateObject/'.$val['id'].'/'.$module.'/'.$valLanguage['canonical'].'') ?>">
                                        ...
                                        <td class="text-center text-primary">
                                            <?php echo form_input('order['.$val['id'].']', $val['order'], 'data-module="'.$module.'" data-id="'.$val['id'].'"  class="form-control sort-order" placeholder="Vị trí" style="width:50px; margin: auto;text-align:right;"');?>
