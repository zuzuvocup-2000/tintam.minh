		...
		<div class="row">
			...
			<div class="col-lg-4">
					...
					<div class="ibox-content">
						...
						<div class="form-row">
							<div class="avatar" style="cursor: pointer;">
								<img id="imagePreview" src="<?php echo (isset($_POST['icon'])) ? $_POST['icon'] : ((isset($product['icon']) && $product['icon'] != '') ? $product['icon'] : 'public/not-found.png') ?>" class="img-thumbnail" alt="">
							</div>
							<input type="text" name="icon" value="<?php echo htmlspecialchars((isset($_POST['icon'])) ? $_POST['icon'] : ((isset($product['icon']) && $product['icon'] != '') ? $product['icon'] : '')); ?>" class="form-control" placeholder="Đường dẫn của ảnh" id="imageTxt" autocomplete="off" style="display:none;">
						</div>
					</div>
				</div>
				<?php */ ?>
				<?php 
					...
					$product_price_promotion = isset($product['price_promotion']) ? $product['price_promotion'] : null;
					
					$product_price = (float)$product_price;

					if (!is_null($product_price_promotion) && $product_price_promotion !== '') {
						$product_price_promotion = (float)$product_price_promotion;
					} else {
						$product_price_promotion = null;
					}

					$formatted_price = number_format($product_price, 0, ',', '.');
					$formatted_price_promotion = is_null($product_price_promotion) ? '' : number_format($product_price_promotion, 0, ',', '.');
				?>
                <div class="ibox mb20 ">
                        ...
                        <div class="row">
							<div class="col-lg-12 m-b">
								<div class="form-row">
									...
									<?php echo form_input('price', validate_input(set_value('price', $formatted_price)), 'class="form-control price" placeholder="" id="price" autocomplete="off"'); ?>
								</div>
							</div>
							<div class="col-lg-12 m-b">
								<label class="control-label ">
								...
								<?php echo form_input('price_promotion', validate_input(set_value('price_promotion', $formatted_price_promotion)), 'class="form-control price_promotion" placeholder="" id="price_promotion" autocomplete="off"'); ?>
							</div>
...
<script>
	$(document).ready(function() {
		...
		var defaultImageUrl = 'public/not-found.png';
