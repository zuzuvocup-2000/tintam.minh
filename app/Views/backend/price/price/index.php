        ...
        <div class="<?php echo (isset($type['value']) && $type['value'] == 'normal') ? '' : 'hidden' ?> col-lg-12 system-general system-normal">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <hr>
                    <form action="" method="">
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20 dpblock-3">
                            <div class="perpage">
                                <div class="uk-flex uk-flex-middle dpblock">
                                    <select name="perpage" class="form-control mgcst input-sm perpage filter mr10">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between dpblock-2">
                                    <div class="uk-search uk-flex uk-flex-middle mr10 ml10 mg0cs">
