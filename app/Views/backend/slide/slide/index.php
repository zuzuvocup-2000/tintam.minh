                            ...
                            <?php if (isset($slideList) && is_array($slideList) && count($slideList)) { ?>
                                <?php foreach ($slideList as $key => $val) { ?>
                                    ...
                                    <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                        ...
                                        <td class=" td-status" data-where="id"><?php echo isset($val['title']) ? $val['title'] : ''; ?></td>
                                        <td class=" td-status" data-where="id">
                                        ...
                                        <td class="text-center td-status-slide" data-field="publish" style="cursor: pointer !important;" data-module="slide_catalogue" data-where="id"><?php echo $status; ?></td>
