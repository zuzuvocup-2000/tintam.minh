						...
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="form-row form-description">
									...
									<?php echo form_textarea('description_catalogue', htmlspecialchars_decode(html_entity_decode(set_value('description_catalogue', (isset($slide_catalogue['description'])) ? $slide_catalogue['description'] : ''))), 'class="form-control ckeditor" id="description" placeholder="" autocomplete="off"'); ?>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-lg-12 clearfix">
				<div class="ibox mb20 album ">
								...
								<div class="click-to-upload" <?php echo (isset($data) && is_array($data) && count($data)) ? 'style="display:none"' : '' ?>>
									<div class="icon">
										<a type="button" class="upload-picture" onclick="SelectBanner($(this));return false;">
											<svg style="width:200px;height:200px;fill: #d3dbe2;margin-bottom: 10px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
					...
					<button type="submit" name="create" value="create" class=" btn btn-primary block m-b pull-right " style="margin-top: 10px;"><?php echo translate('cms_lang.slide.Save1', $language) ?></button>
				</div>
			</div>
		</div>
</form>
