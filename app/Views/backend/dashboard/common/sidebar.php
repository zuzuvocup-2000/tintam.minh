<nav class="navbar-default navbar-static-side" role="navigation">
    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <?php if (in_array('backend/product/catalogue/index', $permission) || in_array('backend/product/product/index', $permission)) { ?>
            ...
            <li class="<?php echo ($uriModule == 'media') ? 'active'  : '' ?>" style="display: none;">
                <a href="index.html"><i class="fa fa-camera-retro" aria-hidden="true"></i> <span class="nav-label">QL Kế hoạch giá</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li class="<?php echo ($uriModule_name == 'catalogue') ? 'active'  : '' ?>"><a href="<?php echo base_url('backend/media/catalogue/index') ?>">QL Nhóm Kế hoạch giá</a></li>
                    <li class="<?php echo ($uriModule_name == 'media') ? 'active'  : '' ?>"><a href="<?php echo base_url('backend/media/media/index') ?>">QL Kế hoạch giá</a></li>
                </ul>
            </li>
            <li class="<?php echo ($uriModule == 'file') ? 'active'  : '' ?>" style="display: none;">
                <a href="index.html"><i class="fa fa-file-text" aria-hidden="true"></i> <span class="nav-label">QL Gallery</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li class="<?php echo ($uriModule_name == 'catalogue') ? 'active'  : '' ?>"><a href="<?php echo base_url('backend/file/catalogue/index') ?>">QL Nhóm Gallery</a></li>
                    <li class="<?php echo ($uriModule_name == 'file') ? 'active'  : '' ?>"><a href="<?php echo base_url('backend/file/file/index') ?>">QL Gallery</a></li>
                </ul>
            </li>
