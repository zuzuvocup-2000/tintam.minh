...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý Gallery</strong></li>
      </ol>
   </div>
                ...
                <div class="ibox-content">
								...
								<?php
									$selected =20;
									 if(isset($_GET['perpage'])){
									  $selected = $_GET['perpage'];
										}

								?>
                                    <select name="perpage" class="form-control input-sm perpage filter mr10" onchange="this.form.submit()">
                                        <option value="20" <?php if($selected == '20'){echo("selected");}?>>20 bản ghi</option>
                                        <option value="30" <?php if($selected == '30'){echo("selected");}?>>30 bản ghi</option>
                                        <option value="40" <?php if($selected == '40'){echo("selected");}?>>40 bản ghi</option>
                                        <option value="50" <?php if($selected == '50'){echo("selected");}?>>50 bản ghi</option>
                                        <option value="60" <?php if($selected == '60'){echo("selected");}?>>60 bản ghi</option>
                                        <option value="70" <?php if($selected == '70'){echo("selected");}?>>70 bản ghi</option>
                                        <option value="80" <?php if($selected == '80'){echo("selected");}?>>80 bản ghi</option>
                                        <option value="90" <?php if($selected == '90'){echo("selected");}?>>90 bản ghi</option>
                                        <option value="100"<?php if($selected == '100'){echo("selected");}?>>100 bản ghi</option>
                                    </select>
                                </div>
                            </div>
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/file/file/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i>Thêm Gallery</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr>
                            ...
                            <?php }} ?>
                            <th class="text-center" style="width:115px;">Ngày ban hành</th>
							<th class="text-center" style="width:103px;"><?php echo translate('cms_lang.post.post_creator', $language) ?></th>
                            <th class="text-center" style="width:103px;"><?php echo translate('cms_lang.post.post_created_at', $language) ?></th>
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td>
                                    <div class="uk-flex uk-flex-middle">
                                        ...
                                        <div class="main-info">
                                            <div class="title"><a class="maintitle" href="<?php echo $val['icon'] ?>" download title=""><?php echo $val['file_title']; ?> </a></div>
                                            <div class="catalogue" style="font-size:10px">
                                                <span style="color:#f00000;">Nhóm Gallery: </span>
                                ...
                                <?php }} ?>
								<td class="text-center text-primary"><?php echo gettime($val['released_at'],'d-m-Y')?></td>
                                <td class="text-center text-primary"><?php echo $val['creator']; ?></td>
