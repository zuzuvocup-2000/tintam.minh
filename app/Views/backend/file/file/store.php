	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<div class="ibox mb20">
					<div class="ibox-title uk-flex-middle uk-flex uk-flex-space-between">
						<h5 class="choose-image" style="cursor: pointer;margin:0;">Giá sản phẩm </h5>
					</div>
					<div class="ibox-content">
						<div class="form-row">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', (isset($file['image'])) ? $file['image'] : ''))), 'class="form-control " placeholder="Đường dẫn của ảnh"  id="imageTxt"  autocomplete="off" ');?>
								</div>
							</div>
						</div>
					</div>
