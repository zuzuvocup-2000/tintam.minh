						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('title', validate_input(set_value('title', (isset($file_catalogue['title'])) ? $file_catalogue['title'] : '')), 'class="form-control '.(($method == 'create') ? 'title' : '').'"  placeholder="" id="title" autocomplete="off"'); ?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row form-description">
									...
									<?php echo form_textarea('description', htmlspecialchars_decode(html_entity_decode(set_value('description', (isset($file_catalogue['description'])) ? $file_catalogue['description'] : ''))), 'class="form-control ck-editor" id="description" placeholder="" autocomplete="off"');?>
						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', (isset($file_catalogue['content'])) ? $file_catalogue['content'] : ''))), 'class="form-control ck-editor" id="content" placeholder="" autocomplete="off"');?>
					...
					<div class="ibox-content">
						<?php
							if(isset($_POST['album'])){
								$album = $_POST['album'];
							}else if(isset($file_catalogue)){
								$album = json_decode($file_catalogue['album'], TRUE);
							}
						 ?>
						<div class="row">
							<div class="col-lg-12">
				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php  
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($file_catalogue['meta_title']) && $file_catalogue['meta_title'] != '') ? $file_catalogue['meta_title'] : translate('cms_lang.post_catalogue.postcat_seo_validate_title', $language)) ;
									$googleLink = (isset($_POST['canonical'])) ? $_POST['canonical'] : ((isset($file_catalogue['canonical']) && $file_catalogue['canonical'] != '') ? BASE_URL.$file_catalogue['canonical'].HTSUFFIX : BASE_URL.'duong-dan-website'.HTSUFFIX) ;
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($file_catalogue['meta_description']) && $file_catalogue['meta_description'] != '') ? $file_catalogue['meta_description'] : translate('cms_lang.post_catalogue.postcat_seo_validate_description', $language)) ;
								?>
								<div class="google">
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('meta_title', htmlspecialchars_decode(html_entity_decode(set_value('meta_title', (isset($file_catalogue['meta_title'])) ? $file_catalogue['meta_title'] : ''))), 'class="form-control meta-title" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_textarea('meta_description', set_value('meta_description', (isset($file_catalogue['meta_description'])) ? $file_catalogue['meta_description'] : ''), 'class="form-control meta-description" id="seoDescription" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($file_catalogue['canonical'])) ? $file_catalogue['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off" data-flag="0" ');?>
												<?php echo form_hidden('original_canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($file_catalogue['canonical'])) ? $file_catalogue['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off"');?>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="form-row">
									<?php echo form_dropdown('parentid', $dropdown, set_value('parentid', (isset($file_catalogue['parentid'])) ? $file_catalogue['parentid'] : ''), 'class="form-control m-b '.($method == 'create' ? $class : '').' select2" data-module="file_catalogue"'); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="form-row">
							...
							<?php echo form_input('router', set_value('router', (isset($file_catalogue['router']) && $file_catalogue['router'] != '') ? $file_catalogue['router'] : '\App\Controllers\Frontend\File\Catalogue::index'), 'class="form-control router-display"  placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
					</div>
				</div>
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="form-row">
							...
							<?php echo form_input('icon', set_value('icon', (isset($file_catalogue['icon'])) ? $file_catalogue['icon'] : ''), 'class="form-control icon-display" placeholder="" autocomplete="off" data-flag="0" ');?>
						</div>
					</div>
				</div>
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									<div class="avatar" style="cursor: pointer;"><img src="<?php echo (isset($_POST['image'])) ? $_POST['image'] : ((isset($file_catalogue['image']) && $file_catalogue['image'] != '') ? $file_catalogue['image'] : 'public/not-found.png') ?>" class="img-thumbnail" alt=""></div>
									<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', (isset($file_catalogue['image'])) ? $file_catalogue['image'] : ''))), 'class="form-control " placeholder="Đường dẫn của ảnh"  id="imageTxt"  autocomplete="off" style="display:none;" ');?>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="form-row">
									...
									<div class="block clearfix">
										<div class="i-checks mr30" style="width:100%;">
											<span style="color:#000;" class="uk-flex uk-flex-middle"> 
												<?php echo form_radio('publish', set_value('publish', 1), ((isset($_POST['publish']) && $_POST['publish'] == 1 || (isset($file_catalogue['publish']) && $file_catalogue['publish'] == 1)) ? true : ((!isset($_POST['publish'])) ? true : false)),'class=""  id="publish"  style="margin-top:0;margin-right:10px;" '); ?>
									...
									<div class="block clearfix">
										<div class="i-checks" style="width:100%;">
											<span style="color:#000;" class="uk-flex uk-flex-middle"> 
												<?php echo form_radio('publish', set_value('publish', 0), ((isset($_POST['publish']) && $_POST['publish'] == 0 || (isset($file_catalogue['publish']) && $file_catalogue['publish'] == 0)) ? true : false),'class=""   id="no-publish" style="margin-top:0;margin-right:10px;" '); ?>
