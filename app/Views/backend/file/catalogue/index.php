...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      <h2>Quản lý Danh mục Gallery</h2>
      <ol class="breadcrumb" style="margin-bottom:10px;">
         <li>
            <a href="<?php echo base_url('backend/dashboard/dashboard/index') ?>">Home</a>
         </li>
         <li class="active"><strong>Quản lý Danh mục Gallery</strong></li>
      </ol>
   </div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Quản lý Danh mục Gallery </h5>
                ...
                <div class="ibox-content">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/file/catalogue/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm mới nhóm Gallery</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                            <?php if(isset($fileCatalogueList) && is_array($fileCatalogueList) && count($fileCatalogueList)){ ?>
                            <?php foreach($fileCatalogueList as $key => $val){ ?>
                            <?php  
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td <?php echo ($val['level'] == 1) ? 'class="text-success text-bold"' : '' ?>>
                                    <a href="<?php echo base_url('backend/file/file/index/?catalogueid='.$val['id'].'') ?>">
                                ...
                                <td class="text-center">
                                    <a type="button" href="<?php echo base_url('backend/file/catalogue/update/'.$val['id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a type="button" href="<?php echo base_url('backend/file/catalogue/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
