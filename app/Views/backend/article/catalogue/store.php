									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_hidden('original_canonical', htmlspecialchars_decode(html_entity_decode(set_value('original_canonical', (isset($article_catalogue['canonical'])) ? $article_catalogue['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off"');?>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="block clearfix">
								<div class="i-checks mr30" style="width:100%;">
									<span style="color:#000;" class="uk-flex uk-flex-middle">
										<?php echo form_radio('template', set_value('template', 'frontend/article/catalogue/index'), ((isset($_POST['template']) && $_POST['template'] == 'frontend/article/catalogue/index' || (isset($article_catalogue['template']) && $article_catalogue['template'] == 'frontend/article/catalogue/index')) ? true : ((!isset($_POST['template'])) ? true : false)),'class=""  id="normal"  style="margin-top:0;margin-right:10px;" '); ?>
