                                    ...
                                    <?php if (isset($cart) && is_array($cart) && count($cart)) { ?>
                                        <form class="woocommerce-cart-form" action="" method="post">
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="product-thumbnail" style="width: 150px;"><span
                                                                class="screen-reader-text">Thumbnail image</span></th>
                                                        <th class="product-name">Sản phẩm</th>
                                                        <th class="product-price">Giá</th>
                                                        <th class="product-quantity">Số lượng</th>
                                                        <th class="product-subtotal">Tổng tiền</th>
                                                        <th class="fc-cart-remove"><span class="screen-reader-text">Remove
                                                                item</span></th>
                                                    </tr>
                                                </thead>
                                                <tbody class="list-product-cart">
                                                    <?php foreach ($cart as $key => $value) { ?>
                                                        ...
                                                        <tr class="woocommerce-cart-form__cart-item cart_item ">
                                                            <input type="hidden" name="rowid" class="productid_hidden"
                                                                value="<?php echo $key ?>">
                                                            ...
                                                            <td class="product-price" data-title="Price">
                                                                <div class="price price_view mb5">
                                                                    <?php echo number_format(check_isset($value['price']), 0, ',', '.') ?>đ<span
                                                                        class="vnd_price"></span></div>
                                                            </td>

                                                            <td class="product-quantity" data-title="Quantity">
                                                                <div class="uk-flex uk-flex-center">
                                                                    <button
                                                                        class="btn_num num_1 button button_qty button_quantity_cart"
                                                                        onclick="var result = document.getElementById('<?php echo $value['rowid'] ?>'); var qtypro = result.value; if( !isNaN( qtypro ) &amp;&amp; qtypro > 1 ) result.value--;return false;"
                                                                        type="button">
                                                                        <i class="fa fa-minus-circle"></i>
                                                                    </button>
                                                                    <input type="text" id="<?php echo $value['rowid'] ?>"
                                                                        name="quantity" value="<?php echo $value['qty'] ?>"
                                                                        maxlength="3"
                                                                        class="form-control prd_quantity input-quantity"
                                                                        onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"
                                                                        onchange="if(this.value == 0)this.value=1;">
                                                                    <button
                                                                        class="btn_num num_2 button button_qty button_quantity_cart"
                                                                        onclick="var result = document.getElementById('<?php echo $value['rowid'] ?>'); var qtypro = result.value; if( !isNaN( qtypro )) result.value++;return false;"
                                                                        type="button">
                                                            ...
                                                            <td class="cart-remove">
                                                                <a href="" class="remove" aria-label="Remove this item"
                                                                    data-product_id="13084" data-product_sku="">×</a>
                                                            </td>
                                                                ...
                                                                <strong>
                                                                    <span class="woocommerce-Price-amount amount">
                                                                        <bdi class="value" id="total"
                                                                            data-price="<?php echo ($cartTotal + 0) ?>"><?php echo number_format($cartTotal, 0, ',', '.') ?><span
                                                                                class="vnd_price">đ</span></bdi>
                                                                    </span>
                                                                </strong>
                                                            </td>
                                                        </tr>
