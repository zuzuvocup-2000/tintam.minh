...
<head>
    ...
    <meta name="author"
        content="<?php echo (isset($general['homepage_company'])) ? $general['homepage_company'] : ''; ?>" />
    <meta name="copyright"
        content="<?php echo (isset($general['homepage_company'])) ? $general['homepage_company'] : ''; ?>" />
    ...
    <meta property="og:image"
        content="<?php echo (isset($meta_image) && !empty($meta_image)) ? $meta_image : base_url(isset($general['homepage_logo']) ? $general['homepage_logo'] : ''); ?>" />
    ...
    <style>
        :root {
            --color-primary:
                <?php echo $general['homepage_color'] ?>
                !important;
        }
    </style>
...
<body data-rsssl="1"
    class="home page wp-schema-pro-2.7.16 <?php echo (isset($ishome) && $ishome == 'home') ? 'home-style1' : ''; ?> wpb-js-composer js-comp-ver-5.0.1 vc_responsive">
                            ...
                            <div class="entry-content clearfix">
                                <div class="woocommerce">
                                    ...
                                    <form name="checkout" method="post"
                                        class=" form form-cart checkout woocommerce-checkout p0" action=""
                                            ...
                                            <div class="uk-width-1-1 uk-width-large-3-5 order2">
                                                <div id="customer_details">
                                                    <div>
                                                        ...
                                                        <p class="note">Bạn phải nhập đầy đủ thông tin bên dưới nếu muốn
                                                            nhận hàng nhanh chóng, chính xác nhất!</p>
                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                            ...
                                                            <p class="form-row form-row-wide validate-required"
                                                                ...
                                                                <span class="woocommerce-input-wrapper"><input
                                                                        require="" class="" type="text"
                                                                        class="input-text" name="fullname" id="fullname"
                                                                        placeholder=""
                                                                        value="<?php echo isset($member['fullname']) ? $member['fullname'] : '' ?>"
                                                            ...
                                                            <p class="form-row form-row-wide validate-required validate-phone"
                                                                ...
                                                                <label for="phone">Số điện thoại&nbsp;<span
                                                                        ...
                                                                        title="required">*</span></label>
                                                                <span class="woocommerce-input-wrapper"><input
                                                                        require="" class="" type="tel"
                                                                        class="input-text" name="phone" id="phone"
                                                                        placeholder=""
                                                                        value="<?php echo isset($member['phone']) ? $member['phone'] : '' ?>"
                                                            ...
                                                            <p class="form-row form-row-wide validate-required validate-email"
                                                                ...
                                                                <span class="woocommerce-input-wrapper"><input
                                                                        ...
                                                                        placeholder=""
                                                                        value="<?php echo isset($member['email']) ? $member['email'] : '' ?>"
                                                                        autocomplete="tel" /></span>
                                                            </p>
                                                            <?php
                                                            ...
                                                            <p class="form-row form-row-wide validate-required"
                                                                ...
                                                                <span
                                                                    class="woocommerce-input-wrapper"><?php echo form_dropdown('cityid', $city, set_value('cityid', (isset($member['cityid'])) ? $member['cityid'] : 0), 'class="form-control select2 m-b city"  id="city"'); ?></span>
                                                            </p>
                                                            <p class="form-row form-row-wide validate-required"
                                                                id="districtid_field">
                                                                ...
                                                                <span class="woocommerce-input-wrapper">
                                                                    <select name="districtid" id="district"
                                                                        class="form-control select2 m-b location change-district">
                                                            ...
                                                            <p class="form-row form-row-wide validate-required"
                                                                id="address_field">
                                                                <label for="address">Địa chỉ&nbsp;<span class="required"
                                                                        title="required">*</span></label>
                                                                <span class="woocommerce-input-wrapper"><input class=""
                                                                        type="address" class="input-text" name="address"
                                                                        id="address" placeholder=""
                                                                        value="<?php echo isset($member['address']) ? $member['address'] : '' ?>" /></span>
                                                            </p>
                                                            <p class="form-row notes" id="messages_field"
                                                                data-priority="">
                                                                <label for="messages">Thông tin bổ sung&nbsp;</label>
                                                                <span class="woocommerce-input-wrapper">
                                                                    <textarea class="" name="messages"
                                                                        class="input-text" id="messages"
                                                                        placeholder="Bạn muốn giao hàng thế nào, ở đâu, mấy giờ..."
                                                                        cols="5" style="height: auto;"></textarea>
                                                                </span>
                                                            </p>
                                                    ...
                                                    <div class="uk-text-right" style="margin-top: 20px;">
                                                        <button type="submit" class="button alt wp-element-button"
                                                            ...
                                                            value="Place order" data-value="Place order">Đặt
                                                            hàng</button>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="wrap-cart-info">
                                                            ...
                                                            <table class=" woocommerce-checkout-review-order-table">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="product-total" style="width: 150px;">Tổng
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                        ...
                                                                        <tr class="cart_item mb10">
                                                                            ...
                                                                            <td class="product-total">
                                                                                <div class="uk-flex uk-flex-middle uk-flex-right"
                                                                                    style="width: 145px;">
                                                                                    <strong
                                                                                        class="product-quantity"><?php echo $val['qty'] ?>
                                                                                        &nbsp;×&nbsp;</strong>
                                                                                    <span
                                                                                        ...
                                                                                        <bdi>
                                                                                            <span class="price new_price"
                                                                                                ...
                                                                                                <?php echo number_format(check_isset($val['detail']['price']), 0, ',', '.') ?>đ<span
                                                                                                    class="vnd_price"></span>
                                                                                </div>
                                                            </div></bdi>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <tfoot>
                                                                    ...
                                                                    <div class="field">
                                                                        <div class="field-input-btn-wrapper">
                                                                            <div class="field-input-wrapper">
                                                                                <label class="field-label" for="code">Mã
                                                                                    giảm giá</label>
                                                                                <input type="hidden"
                                                                                    value="<?php echo isset($voucher['price']) ? $voucher['price'] : '' ?>"
                                                                                    class="voucher_price_hidden">
                                                                                <input type="hidden"
                                                                                    value="<?php echo isset($voucher['voucherid']) ? $voucher['voucherid'] : '' ?>"
                                                                                    class="voucherid_hidden">
                                                                                <input placeholder="Mã giảm giá"
                                                                                    class="field-input discount_code"
                                                                            ...
                                                                            <button type="submit"
                                                                                class="field-input-btn btn btn-default btn-coupon__code">
                                                        ...
                                                        <?php if (isset($shipping) && $shipping > 0): ?>
                                                            <tr>
                                                                <td class="uk-text-left">Tạm tính</td>
                                                                <td class="uk-text-right">
                                                                    <span class="woocommerce-Price-amount amount">
                                                                        <bdi class="value" id="total"
                                                                            data-price="<?php echo ($cartTotal + 0) ?>"><?php echo number_format($cartTotal, 0, ',', '.') ?>đ</bdi>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="uk-text-left">Phí Ship</td>
                                                                <td class="uk-text-right" id="total_shipping"
                                                        ...
                                                        <?php if (isset($discount) && $discount > 0): ?>
                                                            <tr>
                                                                <td class="uk-text-left">Giảm giá</td>
                                                                <td class="uk-text-right" id="total_discount"
                                                                    data-price="<?php echo $discount ?>">
                                                        ...
                                                        <?php
                                                        $member_discount = 0;
                                                        if (isset($member['rank_id'])) {
                                                            $memberRank = get_data(['select' => 'id, name, value', 'table' => 'member_rank', 'where' => ['id' => $member['rank_id']]]);
                                                            $member_discount = (isset($memberRank[0]['value']) ? $memberRank[0]['value'] : 0);
                                                        }
                                                        $minusMemberDiscount = ($cartTotal * $member_discount) / 100;
                                                        ?>

                                                        <?php if ($member_discount > 0): ?>
                                                            <tr>
                                                                <td class="uk-text-left">Khách hàng thân thiết
                                                                    (<?php echo $member_discount ?>%)</td>
                                                                <td class="uk-text-right" id="loyal_customers"
                                                                    data-percent="<?php echo $member_discount ?>">-
                                                                    <?php echo number_format($minusMemberDiscount, 0, ',', '.') ?>đ
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                                                        ...
                                                        <tr class="order-total">
                                                            <th class="uk-text-left"
                                                                style="padding: 15px 0; border-top: 2px solid #eee;">
                                                                Tổng tiền</th>
                                                            <td class="uk-text-right"
                                                                style="padding: 15px 0; border-top: 2px solid #eee;">
                                                                <strong>
                                                                    <span class="woocommerce-Price-amount amount">
                                                                        <bdi class="value" id="total_primary"
                                                                            data-price="<?php echo ($cartTotal - $minusMemberDiscount) ?>"><?php echo number_format($cartTotal - $minusMemberDiscount, 0, ',', '.') ?>đ</bdi>
                                                                    </span>
                                                                </strong>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <div class="woocommerce-terms-and-conditions-wrapper">
                                                            <div class="woocommerce-privacy-policy-text">
                                                                <p>
                                                                    ...
                                                                    đơn đặt hàng, hỗ trợ trải nghiệm của bạn trên
                                                                    trang web này và cho các mục đích khác được mô
                                                                    tả trong chính sách bảo mật của chúng tôi.
