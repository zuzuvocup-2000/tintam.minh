...
$routes->get('gioi-thieu'.HTSUFFIX,'Frontend\Homepage\Home::aboutus');
...
$routes->get('crawl/productcrawler/index', 'Crawl\ProductCrawler::index');
$routes->get('product-crawl', 'Crawl\ProductCrawler::crawl');
...
$routes->group('backend/date/index', ['filter' => 'auth'] , function($routes){
    $routes->add('index', 'Backend/Date/Date::index');
});
