...
function SelectBanner(object,name,count, type){
    ...
    finder.selectActionFunction = function(fileUrl , data, allFiles ) {
        ...
        for(var i = 0 ; i < files.length; i++){
            ...
            li=li+'<li class="ui-state-default select_img__update_banner select_img__add_'+dem_img+'">';
                li=li+'<div class="wrap-select-slide">';
                    li=li+'<div class="thumb">';
                        li=li+'<span class="image img-scaledown">';
                            ...
                            li=li+'<input type="hidden" value="'+fileUrl+'" class="value-img-banner" name="album[]">';
                        li=li+'</span>';
                        li=li+'<div class="overlay"></div>';
                        li=li+'<div class="delete-image"><i class="fa fa-trash" aria-hidden="true"></i></div>';
                    li=li+'</div>';
                    li=li+'<div class="data-slide-panel ">';
                        li=li+'<div class="form-group form-item-va">';
                            li=li+'<label class="col-xs-4 control-label" for="attachment-details-two-column-alt-text" class="name">Văn bản thay thế</label>';
                            li=li+'<div class="col-xs-8">';
                                li=li+'<input type="text" id="attachment-details-two-column-alt-text" value="" name="alt[]" placeholder="Văn bản thay thế" class="form-control form_font_weght">';
                            li=li+'</div>';
                        li=li+'</div>';
                       li=li+' <div class="form-group form-item-va">';
                            li=li+'<label class="col-xs-4 control-label"  for="attachment-details-two-column-title">Tiêu đề</label>';
                            li=li+'<div class="col-xs-8"> ';
                                li=li+'<input type="text" id="attachment-details-two-column-title" placeholder="Tiêu đề..." value="" name="title[]" class="form-control form_font_weght"> ';
                            li=li+'</div>';
                        li=li+'</div>';
                        li=li+'<div class="form-group form-item-va">';
                            li=li+'<label class="col-xs-4 control-label"  for="attachment-details-two-column-canonical">Đường dẫn</label>';
                            li=li+'<div class="col-xs-8"> ';
                                li=li+'<input type="text" id="attachment-details-two-column-canonical" placeholder="Đường dẫn..." value="" name="canonical[]" class="form-control form_font_weght"> ';
                            li=li+'</div>';
                        li=li+'</div>';
                        li=li+'<div class="form-group form-item-va">';
                            li=li+'<label class="col-xs-4 control-label" for="attachment-details-two-column-description">Mô tả</label>';
                            li=li+'<div class="col-xs-8"> ';
                                li=li+'<textarea id="attachment-details-two-column-description" placeholder="Mô tả..." value="" name="description[]" class="form-control form_font_weght"></textarea> ';
                            li=li+'</div>';
                        li=li+'</div>';
                        li=li+'<div class="form-group form-item-va">';
                            li=li+'<label class="col-xs-4 control-label" for="attachment-details-two-column-caption">Nội dung</label>';
                            li=li+'<div class="col-xs-8"> ';
                                li=li+'<textarea id="attachment-details-two-column-caption" placeholder="Nội dung" value="" name="content[]" class="form-control form_font_weght"></textarea> ';
                            li=li+'</div>';
                        li=li+'</div>';
                    li=li+'</div>';
                li=li+'</div>';
